    ...
    <div class="row text-center" id="shirt">
            ...
            <div class="col-md-3 col-6 py-3">
                <div class="card">
                    ...
                    <div class="figure-caption">
                        <h6>Cylindrical Ceramic Planter</h6>
                        <h6>Price :Rs 450</h6>
                        <?php if (!isset($_SESSION['email'])) {?>
                    <p><a href="index.php#login" role="button" class="btn btn-warning  text-white ">Add To Cart</a></p>
                    <?php
            ...
            <div class="col-md-3 col-6 py-3" >
                <div class="card">
                    ...
                    <div class="figure-caption">
                        <h6>Football Ceramic Planter</h6>
                        <h6>Price :Rs 800</h6>
                        <?php if (!isset($_SESSION['email'])) {?>
                    <p><a href="index.php#login" role="button" class="btn btn-warning  text-white ">Add To Cart</a></p>
                    <?php
            ...
            <div class="row text-center" id="headphones">
                    ...
                    <div class="col-md-3 col-6 py-3">
                        <div class="card">
                            ...
                            <div class="figure-caption">
                                <h6>Garden Water Spray (1 ltr)</h6>
                                <h6>Price :Rs 100</h6>
                                <?php if (!isset($_SESSION['email'])) {?>
                    <p><a href="index.php#login" role="button" class="btn btn-warning  text-white ">Add To Cart</a></p>
                    <?php
                   ...
                   <?php
                    ...
                    <div class="col-md-3 col-6 py-3">
                        <div class="card">
                            ...
                            <div class="figure-caption">
                                <h6>Garden Water Spray (2 ltr)</h6>
                                <h6>Price :Rs 500</h6>
                                <?php if (!isset($_SESSION['email'])) {?>
                    <p><a href="index.php#login" role="button" class="btn btn-warning  text-white ">Add To Cart</a></p>
                    <?php
        ...
        <div class="col-md-3 col-6 py-2">
            <div class="card">
                ...
                <div class="figure-caption">
                    <h6>High-Quality Cocopeat (650gm)</h6>
                    <h6>Price :Rs 150</h6>
                    <?php if (!isset($_SESSION['email'])) {?>
                    <p><a href="index.php#login" role="button" class="btn btn-warning  text-white ">Add To Cart</a></p>
                    <?php
